...
$ git clone https://github.com/KleitonEwerton/sistema_de_pagamento_em_java.git

# Acesse a pasta do projeto no terminal/cmd
$ cd sistema_de_pagamento_em_java
...
$ java -jar sistemadepagamento-1.0-SNAPSHOT-jar-with-dependencies.jar
